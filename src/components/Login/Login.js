...
class Login extends React.Component {
  ...
  render() {
    ...
    if (redirect === true || logged === true) { return <Redirect to={from} />; }
    return (
      <section className="login">
        ...
        {error ? (
          <h2>
            ...
            <span role="img" aria-label="Hands pressed together">🙏</span>
          </h2>
        ) : (
          <h2 style={{ padding: '15px' }}>
            ...
            {' '}
            <span role="img" aria-label="information desk man">💁‍♂️</span>
            <br />
          </h2>
        )
        }
